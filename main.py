...
if File_Choice == 'c' or File_Choice == 'C':
    data_csv.to_csv(r'C:\Users\laksh\Desktop\New\Project\Frame_Pitches.csv', index=False)
elif File_Choice == 't' or File_Choice == 'T':
    data_csv.to_csv(r'C:\Users\laksh\Desktop\New\Project\Frame_Pitches.txt', index=True)
